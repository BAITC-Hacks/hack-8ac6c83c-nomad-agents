...
- Publish one concise route/DTO decision in this brief or a small `docs/backend/contract.md`: retain the existing task and proposal routes from the scaffold, omit standalone AI score and preview for this demo, and do not expose fake optional endpoint responses.
